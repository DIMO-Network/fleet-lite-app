...
// '-') and a uuid never contains '_'. That invariant is what lets a reader
// distinguish legacy bare-slug ids from tenant-scoped ones without a lookup —
// if it ever breaks, that classification silently fails.
